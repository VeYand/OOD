...
TEST(DuoWeatherStationDisplay, MockObserverReceivesUpdates)
{
    ...
    constexpr SWeatherInfo dataIn = {30, 0.5, 761.0, {10, 180}};
    constexpr SWeatherInfo dataOut = {24, 0.75, 762.0, {1, 10}};
    ...
    weatherDataIn.SetMeasurements(dataIn.temperature, dataIn.humidity, dataIn.pressure, dataIn.wind);
    weatherDataOut.SetMeasurements(dataOut.temperature, dataOut.humidity, dataOut.pressure, dataOut.wind);
}
