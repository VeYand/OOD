...
{
public:
	CFishermanDisplay(IObservable<SWeatherInfo, WeatherEventType> *inStation,
...
private:
	...
	void Update(const SWeatherInfo &data, WeatherEventType eventType,
	            IObservable<SWeatherInfo, WeatherEventType> *observable) override
	{
